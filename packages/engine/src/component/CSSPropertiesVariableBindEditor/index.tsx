...
import { CNodePropsTypeEnum, JSExpressionPropType } from '@chameleon/model';
...
export const CSSPropertiesVariableBindEditor = forwardRef<CSSPropertiesVariableBindEditorRef, CSSPropertiesVariableBindEditorProps>(
